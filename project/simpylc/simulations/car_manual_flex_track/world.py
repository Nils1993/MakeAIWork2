...
trackType = 'easy' if input ('Easy or hard track <e/h>: ') == 'e' else 'hard'  # Should be done prior to any SimPyLC related imports due to concurrency
